...
const Hero = () => {
  return (
<section className="relative bg-cover bg-center h-[90vh] text-white px-6 flex items-center justify-center" style={{backgroundImage: `url('./heroImgNew.jpeg')`}}>
        <div className="flex items-center mx-0 max-w-6xl min-h-48">

            <div className="text-center">
                <h2 className="text-4xl font-bold tracking-wide mb-4 ">Natural Beauty. Feel Bold</h2>
